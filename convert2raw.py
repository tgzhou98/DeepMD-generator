...
def param_interface(test_configs_path_absolute: str):

    lc = get_line_c(test_configs_path_absolute)
    ...
    data = np.loadtxt(test_configs_path_absolute)
...
def _main():
    ...
    parser.add_argument(
        'INPUT', default="test.configs", help='the input json database ')
