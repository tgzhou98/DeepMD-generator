...
def param_interface(vasp_dir_absolute: str, recursive: bool) -> int:
    """TODO: Docstring for param_interface.

    :vasp_dir_absolute: str: TODO
    :recursive: bool: TODO
    :returns: TODO
    ...
    if os.path.isdir(vasp_dir_absolute):
        outcars += get_outcar_files(vasp_dir_absolute, recursive)
    else:
        outcars.append(vasp_dir_absolute)
    ...
    all_configs = 0
    for each_outcar in data:
        all_configs += each_outcar[0]
